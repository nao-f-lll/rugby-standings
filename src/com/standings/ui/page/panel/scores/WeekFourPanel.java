...
public class WeekFourPanel extends JPanel implements ActionListener{
	...
	public WeekFourPanel(ArrayList<Team> teams, ArrayList<Game> games, ArrayList<Week> weeks) {
