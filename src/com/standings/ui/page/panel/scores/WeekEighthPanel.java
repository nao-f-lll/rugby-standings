...
public class WeekEighthPanel extends JPanel implements ActionListener{


	/**
	 * 
	 */
	private static final long serialVersionUID = -857345892216391163L;
	...
	final int  GAME_ONE = 21;
	final int  GAME_TWO = 22;
	final int  GAME_THREE = 23;
	private JPanel gameThreePanel;
	private JPanel gameTwoPanel;
	private JPanel gameOnePanel;
	private JButton exoportXMLButton;

	public WeekEighthPanel(ArrayList<Team> teams, ArrayList<Game> games,  ArrayList<Week> week) {
