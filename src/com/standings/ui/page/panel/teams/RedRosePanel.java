...
public class RedRosePanel extends JPanel{

	/**
	 * 
	 */
	private static final long serialVersionUID = 3206326020267850352L;
	...
	public RedRosePanel () {
		...
		this.setBounds(0, 115, 1525, 845);
	   	...
	   	icon = new ImageIcon(RedRosePanel.class.getResource("/images/red_rose_logo.png"));
